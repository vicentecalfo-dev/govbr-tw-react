...
const CardHeader: FC<CardHeaderProps> = ({ className, children, ...props }) => {
  return (
    <header
      className={cn(
...
const CardMain: FC<CardMainProps> = ({ className, children, ...props }) => {
  return (
    <main
...
const CardFooter: FC<CardFooterProps> = ({ className, children, ...props }) => {
  return (
    <footer

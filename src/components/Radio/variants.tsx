...
const variants = cva("block appearance-none rounded-full hover:cursor-pointer border from-45%  to-50% to-transparent checked:bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] disabled:opacity-60 disabled:cursor-not-allowed disabled:hover:bg-transparent", {
  variants: {
    variant: {

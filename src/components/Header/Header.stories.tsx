...
export const Default = () => (
  <div className="w-full">
    <Header
      locator="Ministério do Meio Ambiente e Mudança do Clima"
      headerTitle="JBRJ/CNCFlora &bull; Centro Nacional de Conservação da Flora"
      onChangeSearchInput={(value)=> console.log(value)}
      onSubmitSearchInput={(value)=>console.log(value)}
      menu={menu}
    >
      <Header.PrimaryMenu>
